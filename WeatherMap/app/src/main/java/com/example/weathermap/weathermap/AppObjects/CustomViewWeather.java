...
public class CustomViewWeather extends LinearLayout {
    ...
    // Constructor
    public CustomViewWeather(Context context) {
        super(context);
        init(context);
    }

    public CustomViewWeather(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
